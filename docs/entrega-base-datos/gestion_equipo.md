...
| -------------------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| Nicolas Estid Ruiz Sastoque      | Lider del proyecto  desarrollador y QA<br /> | Liderar decisiones tecnicas, ADR, ambiente, Liquibase, DDL de parametrizacion/seguridad, DCL roles/grants y TCL. |
