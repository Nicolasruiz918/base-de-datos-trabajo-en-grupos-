...
CREATE UNIQUE INDEX IF NOT EXISTS ux_user_rolee ON security.user_rolee (user_id, rolee_id);
CREATE UNIQUE INDEX IF NOT EXISTS ux_rolee_permission ON security.rolee_permission (rolee_id, permission_id);
...
CREATE INDEX IF NOT EXISTS ix_reservation_customer ON service_delivery.room_reservationtion (customer_id);
CREATE INDEX IF NOT EXISTS ix_room_reservationtion_date ON service_delivery.room_reservationtion (room_id, start_date, end_date);
CREATE UNIQUE INDEX IF NOT EXISTS ux_cancellation_reservation ON service_delivery.reservationtion_cancellation (room_reservationtion_id);
CREATE UNIQUE INDEX IF NOT EXISTS ux_stay_reservation ON service_delivery.stay (room_reservationtion_id);
CREATE UNIQUE INDEX IF NOT EXISTS ux_check_in_reservation ON service_delivery.check_in (room_reservationtion_id);
...
CREATE INDEX IF NOT EXISTS ix_payment_reservation ON billing.partial_payment (room_reservationtion_id);
...
CREATE INDEX IF NOT EXISTS ix_alert_reservation ON notification.alert (room_reservationtion_id);
