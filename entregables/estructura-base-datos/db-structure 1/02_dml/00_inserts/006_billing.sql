INSERT INTO billing.pre_invoice (
  stay_id,
  room_reservationtion_id,
  customer_id,
  subtotal,
  tax,
  discount
)
SELECT e.id, e.room_reservationtion_id, e.customer_id, 240000, 45600, 0
...
INSERT INTO billing.partial_payment (room_reservationtion_id, payment_method_id, value, payment_reference)
...
WHERE r.start_date = TIMESTAMPTZ '2026-05-10 15:00:00-05'
  AND NOT EXISTS (
    ...
    WHERE pp.room_reservationtion_id = r.id
